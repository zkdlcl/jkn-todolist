...
**상태**: 초안 (Draft)
**관련 문서**: [PRD](./2-product-requirements.md), [도메인 정의서](./1-domain-definition.md)
...
| 페르소나      | 주요 시나리오                                                  | 시나리오 수 |
| ------------- | -------------------------------------------------------------- | ----------- |
| 대학생 이계획 | SC-001, SC-004, SC-007, SC-012                                 | 4           |
| 직장인 김효율 | SC-002, SC-003, SC-005, SC-006, SC-008, SC-009, SC-010, SC-011 | 8           |
